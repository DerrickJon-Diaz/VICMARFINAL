...
import galleryImage1 from "../../images/Render 001 - Main Avenue UP.png";
import galleryImage2 from "../../images/Render 002 - Sico Rotonda UP.jpeg";
import galleryImage3 from "../../images/heroimage.jpg";
...
import galleryImage6 from "../../images/REVISED_Render 002 - parks and playgrounds UP.png";
import lifestyleImage from "../../images/REVISED_Render 006 - Close_Main Entrance Gate UP.png";
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  <h2 className="text-2xl font-bold text-[#16a34a] mb-6">Live your dream lifestyle at Vicmar Homes</h2>
                  <div className="flex flex-wrap gap-2 mb-8">
                    {[
                      "accessible communal parks",
