...
const propertyTypes = [
  {
    ...
    label: "Duplex Units",
    icon: Building,
    description: "Duplex homes featuring modern architecture and thoughtfully designed layouts. Ideal for growing families seeking quality living spaces and spacious interiors.",
    image: duplexImg
  },
  {
    type: "triplex",
    label: "Triplex Units",
    icon: Building2,
    description: "Affordable triplex homes available in End Unit and Center Unit configurations. Designed with practical and functional layouts, these homes are ideal for family living.",
    image: triplexImg
  },
  {
    type: "rowhouse",
