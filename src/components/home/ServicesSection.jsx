...
const services = [
  {
    ...
    description: "Eco-friendly residences designed to promote resource efficiency and environmentally responsible living.",
  },
  {
    icon: TrendingUp,
    title: "Affordable Community Housing",
    description: "Practical and budget-friendly homes built to support families in achieving stable homeownership.",
  },
  {
    icon: Shield,
    title: "Eco-Garden Communities",
    description: "Neighborhoods that encourage home-based food gardening for healthier and more self-sufficient living.",
  },
  {
    icon: FileCheck,
    title: "Family-Oriented Neighborhood",
    description: "A safe and supportive environment built to nurture family growth and connection.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Reveal className="text-center mb-14">
          ...
          <p className="text-gray-500 max-w-xl mx-auto text-sm">
            Find your perfect home—where comfort, design, and your future align.
          </p>
        </Reveal>
