...
const SUPPORT_ADMIN_PAGES_WITH_LAYOUT = new Set(["SupportAdminOverview", "SupportAdminVicinityStatus", "AdminMessages"]);

const LayoutWrapper = ({ children, currentPageName }) => {
  if (currentPageName === "AdminMessages") {
    ...
    if (isSupportAdminUser(currentUser)) {
